     ...
     <div className="flex">
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-12">
          <form onSubmit={handleOnSubmit} className='w-full max-w-md bg-white p-8 rounded-lg border shadow-sm' >
              ...
              <button className="w-full bg-black text-white p-2 rounded-lg font-semibold hover:bg-gray-800 transistion">
                  Sign Up
              </button>
        ...
        <div className="hidden md:block w-1/2 bg-gray-800">
          <div className="h-full flex flex-col justify-center items-center">
            <img src="" alt="login image" className='h-[750px] w-full object-cover' />
          </div>
        </div>
